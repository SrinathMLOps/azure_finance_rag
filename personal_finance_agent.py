...
# Azure AI credentials for OpenAI SDK
endpoint = "https://rg-financetracker.cognitiveservices.azure.com/"
model_name = "gpt-4.1-nano"  # Updated model name
deployment = "gpt-4.1-nano"  # Updated deployment name
subscription_key = "7yYRL1RxpmLLhbc1bf8Dk6XCNeFcStzusbIeoC6AOCMVvHf3W4fnJQQJ99BHACHYHv6XJ3w3AAAAACOGPdB2"
api_version = "2024-12-01-preview"

# Function to create Azure AI client using OpenAI SDK
@st.cache_resource
...
with st.expander("How to get your Azure AI credentials"):
    ...
    **Required Python packages:**
    ```bash
    pip install streamlit PyPDF2 pandas openpyxl openai
    ```
    """)
